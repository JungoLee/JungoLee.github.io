jQuery(document).ready(function(){
	...
	$('.draggable').on('dragstop',function(){
		var random = Math.floor(Math.random() * $('.draggable').length);
		var left=$(this).offset().left;
		var top=$(this).offset().top;	
		var color2=$(this).find('input').val();
		var textColor=$('.draggable').eq(random).find('input').val();
		...
		$('.content1 .text').css({color:textColor});
		}; 
		...
		$(this).stop().animate({top:top-top, left:left-left});
		$('.content2 .text').css({color:textColor});
		}; 
		...
		$(this).stop().animate({top:top-top, left:left-left});
		$('.content3 .text').css({color:textColor});
		}; 
		$(this).stop().animate({top:top-top, left:left-left});
	});
