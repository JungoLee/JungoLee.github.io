	...
	var textHover=$('#contentBox>.contentLine>p>.text')
		
		textHover.hover(function(){
			var tg=$(this);

			tg.animate({left:'15px'},{duration:800,queue:false,easing:'easeOutCubic'});
	
		},function(){
			var tg=$(this);

			tg.animate({left:0},{duration:800,queue:false,easing:'easeOutCubic'});

		});
	//tab 부분 hover로 색변경
	var tabHover=$('#topLine>.selectBox>.box');
	var tabHover2=$('#page_num_box>a');	
		tabHover2.hover(function(){
			var tg=$(this);
